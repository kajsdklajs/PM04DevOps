...
def update_color(*args):
    ...
    # Обновление цвета прямоугольника
    color_hex = f'#{r:02x}{g:02x}{b:02x}'
    canvas.config(bg=color_hex)
    
    # Обновление текста с кодом цвета
...
# Переменные для хранения значений RGB
